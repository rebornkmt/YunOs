...
body {
	font-size: 12px;
	background:#06C url(wallpapers/bg8.jpg) repeat scroll center center;/*壁纸*/
...
<ul id="deskIcon">
<li class="desktop_icon" id="win12" path="Backstage/info.php"> <span class="icon"><img src="icon/user2.png"/></span>
    <div class="text"><?php @session_start(); echo @$_SESSION['name']; if(@$_SESSION['name']==""){echo "我";}?>
      <div class="right_cron"></div>
    </div>
  </li>
  <li class="desktop_icon" id="win5" path="photo.html"> <span class="icon"><img src="icon/photo2.png"/></span>
    <div class="text">相册
      <div class="right_cron"></div>
    </div>
  </li>
  <li class="desktop_icon" id="win6" path="Backstage/activity.html"> <span class="icon"><img src="icon/activity.png"/></span>
    <div class="text">活动
      <div class="right_cron"></div>
    </div>
  </li>
  <li class="desktop_icon" id="win7" path="Backstage/date.php"> <span class="icon"><img src="icon/date.png" width="64" height="64"/></span>
    <div class="text">日历
      <div class="right_cron"></div>
    </div>
  </li>
  <li class="desktop_icon" id="win8" path="Backstage/message.html"> <span class="icon"><img src="icon/message.png"/></span>
    <div class="text">消息
      <div class="right_cron"></div>
    </div>
  </li>
  <li class="desktop_icon" id="win9" path="Backstage/call.php"> <span class="icon"><img src="icon/call.png"/></span>
    <div class="text">通讯录
      <div class="right_cron"></div>
    </div>
  </li>
  <li class="desktop_icon" id="win10" path="Backstage/Notice.php"> <span class="icon"><img src="icon/notice.png"/></span>
    <div class="text">公告
      <div class="right_cron"></div>
    </div>
  </li>
  <li class="desktop_icon" id="win11" path="http://music.baidu.com"> <span class="icon"><img src="icon/music.png"/></span>
    <div class="text">音乐
      <div class="right_cron"></div>
    </div>
  </li>
   </li>
  <li class="desktop_icon" id="win13" path="http://www.baidu.com"> <span class="icon"><img src="icon/Browser.png"/></span>
    <div class="text">浏览器
      <div class="right_cron"></div>
    </div>
  </li>
  <li class="desktop_icon" id="win14" path="http://www.gdcxxy.net"> <span class="icon"><img src="icon/school.png"/></span>
    <div class="text">学校官网
      <div class="right_cron"></div>
    </div>
     <li class="desktop_icon" id="win15" path="https://www.toutiao.com"> <span class="icon"><img src="icon/new.png"/></span>
    <div class="text">新闻
      <div class="right_cron"></div>
    </div>
  </li>
    <li class="desktop_icon" id="win16" path="https://map.baidu.com"> <span class="icon"><img src="icon/address.png"/></span>
    <div class="text">地图
      <div class="right_cron"></div>
    </div>
  </li>
...
<div id="lr_bar">
  <ul id="default_app">
    <li id="app0"><img src="icon/System.png" width="64" height="64" title="系统信息" path="Backstage/activity.html"/></li>
    <li  id="app2"><img src="icon/study.png" title="在线学习" path="http://www.w3school.com.cn"/></li>
    <li id="app3"><img src="icon/wecall.png" title="联系我们" path=""/></li>
    <li id="app4"> <img src="icon/ly.png" title="在线留言" path=""/></li>
    <li id="app1"><img src="icon/game.png" title="游戏" path="game\01\index.html"/></li>
  </ul>
  
  <div id="start_block"><a title="开始" id="start_btn"><img src="icon/yun.png" width="55" height="50"></a>
    <div id="start_item">
      <ul class="item admin">
